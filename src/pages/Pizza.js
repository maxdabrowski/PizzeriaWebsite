      ...
      <table>
        <tbody>
          <tr className='row' >
            ...
            <td>{size[0]} cm</td>
            <td>{price[0]} zł</td>  
            <td title="Dodaj do zamówienia" onClick={() => addPizzaOrder(name,size[0],price[0])}><i class="fas fa-plus-square"></i></td>
          </tr>
          <tr  className='row'>
            <td>średnia</td>
            <td>{size[1]} cm</td>
            <td>{price[1]} zł</td>
            <td title="Dodaj do zamówienia" onClick={() => addPizzaOrder(name,size[1],price[2])}><i class="fas fa-plus-square"></i></td>         
          </tr>
          <tr  className='row'>
            <td>duża</td>
            <td>{size[2]} cm</td>
            <td>{price[2]} zł</td>
            <td title="Dodaj do zamówienia" onClick={() => addPizzaOrder(name,size[2],price[2])} ><i class="fas fa-plus-square"></i></td>
          </tr>
        </tbody>
      </table>
